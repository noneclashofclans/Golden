  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="w-full bg-black/50 border border-white/10 rounded-xl py-4 pl-12 pr-4 focus:outline-none focus:border-yellow-500/50 transition-all text-sm placeholder:text-slate-600 text-white"
      />
            ...
            <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); navigate('/dashboard'); }}>
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="w-full bg-yellow-500 text-black font-black py-4 rounded-xl flex items-center justify-center gap-2 uppercase tracking-widest text-xs shadow-[0_0_30px_rgba(234,179,8,0.25)] hover:bg-yellow-400 transition-colors relative overflow-hidden group"
                >
                  {/* Shimmer */}
